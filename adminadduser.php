...
<br>
<input type="email" name="email" placeholder="NITC Email" required>
<br>
...
<center>  <button type="submit" style="width:70px;height: 40px ;padding: 10px;font-size: 16px">Add</button></center>
<br>
</div>
   </form>
  </div>
